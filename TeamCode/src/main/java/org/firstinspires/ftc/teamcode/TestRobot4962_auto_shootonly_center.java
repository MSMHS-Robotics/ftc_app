 ...
 *
 */
@Autonomous(name = "Auto Red Shoot Only Center", group = "Team")
//@Disabled
public class TestRobot4962_auto_shootonly_center extends LinearOpMode {
	...
	public void runOpMode() throws InterruptedException {
		...
		DriveOnHeadingReverse(yawPIDResult,-40,20);
		stop();
