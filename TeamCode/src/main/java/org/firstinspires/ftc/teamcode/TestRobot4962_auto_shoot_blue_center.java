 ...
 *
 */
@Autonomous(name = "Auto Blue Shoot Only Center", group = "Team")
//@Disabled
public class TestRobot4962_auto_shoot_blue_center extends LinearOpMode {
	...
	public void runOpMode() throws InterruptedException {
		...
		DriveOnHeadingReverse(yawPIDResult,45,16);
